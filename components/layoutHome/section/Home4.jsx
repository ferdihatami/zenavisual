    ...
    <>
      <div className="p-8 mb-5">
        <div className="text-center mt-8">
          <p className="font-medium text-[1.5rem] tracking-wide">
            Fitur Undangan Digital
          </p>
          <p className="mt-5">
            Fitur undangan online digital yang bisa kamu dapatkan ada di
            zenavisual <br /> Sehingga memudahkan kamu untuk berbagi informasi
      ...
      <div className="lg:grid lg:grid-cols-3 lg:gap-5 mx-20 mb-24 space-y-8">
        ...
        <div className="border hover:shadow-2xl ease-out duration-700 rounded-lg lg:p-10 p-4">
          <div className="text-center">
            ...
            <p className="mt-2">
              Hitung mundur waktu sebagai pengingat acara kamu
            </p>
          </div>
        </div>
        ...
        <div className="border hover:shadow-2xl ease-out duration-700 rounded-lg lg:p-10 p-4">
          <div className="text-center">
            ...
            <p className="mt-2">
              Kamu bisa membagikan undangan sesuai dengan nama tamu
            </p>
          </div>
        </div>
